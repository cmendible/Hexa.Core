...
namespace Hexa.Core.Domain
{
        ...
        where TKey : struct, IEquatable<TKey>
    {
        ...
        public virtual void Add(TEntity entity)
        {
            ...
            this.logger.LogDebug(string.Format(CultureInfo.InvariantCulture, "Added a {0} entity", typeof(TEntity).Name));
        }
        ...
        public void Attach(TEntity entity)
        {
            ...
            this.logger.LogDebug(string.Format(CultureInfo.InvariantCulture, "Attached {0} to context", typeof(TEntity).Name));
        }
            ...
            bool ascending = true)
        {
            ...
            this.logger.LogDebug(string.Format(CultureInfo.InvariantCulture, "Getting filtered elements {0} with filter: {1}", typeof(TEntity).Name, filter.ToString()));
        ...
        public virtual void Modify(TEntity entity)
        {
            ...
            this.logger.LogDebug(string.Format(CultureInfo.InvariantCulture, "Applied changes to: {0}", typeof(TEntity).Name));
        }
        ...
        public virtual void Remove(TEntity entity)
        {
            ...
            this.logger.LogDebug(string.Format(CultureInfo.InvariantCulture, "Deleted a {0} entity", typeof(TEntity).Name));
        }
